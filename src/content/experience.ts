  ...
  experiences: [
    {
      ...
      summaries: [
        '负责集团及兴海·颐华、兴海·唯璞两家酒店品牌的内容与线上传播，覆盖抖音、视频号、小红书和微信公众号。我统筹并执行选题、脚本、拍摄、剪辑、调色、包装、发布的完整链路。',
      ...
      detailBlocks: [
        ...
        },
        {
          kicker: '全链路制作',
          title: '从选题到发布的完整执行',
          body: '我统筹并执行选题、脚本、拍摄、剪辑、调色、包装与发布，覆盖从想法到上线的完整制作链路。',
        },
        {
          kicker: '钉钉与 AI 提效',
          title: '让图片类交付更紧凑',
          body: '在创意、素材和生产环节使用 AI；图片类交付由约一周缩短至 3 天，内容质量与品牌一致性也得到明显提升。',
        },
        {
          kicker: '数字化环境',
          title: '网站与工作环境建设',
          body: '负责集团网站、网络及数字化工作环境建设，相关 AI、网站与多 Agent 协作能力也在这段工作中持续形成。',
        },
      ],
      metrics: [
        {
        ...
        },
        {
          value: '约1周→3天',
          label: '图片类交付周期',
          context: '交付周期缩短，内容质量与品牌一致性明显提升。',
        },
      ],
      publicNotes: [
        '图片类交付周期由约一周缩短至 3 天，内容质量与品牌一致性明显提升。',
    ...
    },
    {
      ...
      summaries: [
        ...
        '公道杯内容围绕办公喝茶痛点展开，通过画质、光影与细节建立品牌溢价；游侠纯钛外出与露营茶具则突出纯钛材质、可定制配色、产品颜值、便携性与户外场景。',
      ],
      detailBlocks: [
        {
          kicker: '公道杯洞察',
        ...
        },
        {
          kicker: '游侠产品表达',
          title: '纯钛材质与户外场景',
          body: '突出纯钛高端材质、可定制配色、产品颜值、便携和外出／露营场景，建立与公道杯不同的表达方向。',
        },
      ],
      metrics: [
        {
    ...
    },
    {
      ...
      summaries: [
        '负责从零搭建直播间，覆盖采购和成本、灯光器材、软装场布、采集与传输信号、线上电子物料及主播面试，把一个尚未成型的直播间先搭出可以持续运营的基本骨架。',
        '通过人群分析识别饮水安全、饮水便捷、桌面陈设和品质生活需求，以饮水安全为重点题材，围绕产品优势、痛点开头与千川素材完成策划、拍摄、剪辑、调色、发布投放与复盘，并持续优化文案信息密度和主播话术。',
      ],
      detailBlocks: [
        {
          kicker: '从零搭建',
          title: '把直播间基础环节跑通',
          body: '负责采购与成本、灯光器材、软装场布、采集与传输信号、线上电子物料及主播面试，从零搭建直播间的工作基础。',
        },
        {
          kicker: '人群洞察',
          title: '从需求决定饮水安全题材',
          body: '通过人群分析识别饮水安全、饮水便捷、桌面陈设和品质生活需求，并据此选择饮水安全作为重点题材。',
        },
        {
          kicker: '内容制作',
          title: '围绕痛点开头与产品优势制作',
        ...
        },
        {
          kicker: '直播话术与数据',
          title: '持续优化直播间表达',
          body: '优化主播话术和内容信息密度，结合直播间数据持续复盘，让直播间从零开始逐步形成稳定的内容与运营节奏。',
        },
      ],
      metrics: [
        {
