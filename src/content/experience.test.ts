...
describe('experience content', () => {
  it('provides the long-form work experience structure', () => {
    ...
    for (const experience of experienceContent.experiences) {
      ...
      expect(experience.publicNotes.length).toBeGreaterThan(0);
  ...
  it('keeps the confirmed work facts in their own experience entries', () => {
  ...
  it('keeps About facts aligned with the long-form experience source', () => {
